...
class OpportunityEditForm extends React.Component {
  ...
  componentDidMount() {
    fetch(
      `http://localhost:3001/api/v1/opportunities/${this.props.routerProps.match.params.id}`
    )
      .then((res) => res.json())
      .then((data) =>
        this.setState({
      ...
      <div style={{ textAlign: "center" }}>
        ...
        >
          ...
          <TextField
            ...
            helperText="Please select the deal value"
            select
            required
          >
          ...
          <TextField
            ...
            helperText="Please select the deal priority"
            select
          >
